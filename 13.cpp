...
public:
    ...
    float perimetro() override {
        // Suponemos que es un tri�ngulo equil�tero para este ejemplo
        return 3 * base;
    }
};

int main() {
    // Crear objetos de las figuras geom�tricas
    Cuadrado cuadrado(5);
    Circulo circulo(3);
    Triangulo triangulo(4, 5);

    // Calcular y mostrar el �rea y el per�metro de cada figura
    cout << "Cuadrado:" << endl;
